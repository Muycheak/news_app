...
class $AssetsFontsGen {
  ...
  /// File path: assets/fonts/PlayfairDisplay-Black.ttf
  String get playfairDisplayBlack => 'assets/fonts/PlayfairDisplay-Black.ttf';

  /// File path: assets/fonts/PlayfairDisplay-BlackItalic.ttf
  String get playfairDisplayBlackItalic =>
      'assets/fonts/PlayfairDisplay-BlackItalic.ttf';

  /// File path: assets/fonts/PlayfairDisplay-Bold.ttf
  String get playfairDisplayBold => 'assets/fonts/PlayfairDisplay-Bold.ttf';

  /// File path: assets/fonts/PlayfairDisplay-BoldItalic.ttf
  String get playfairDisplayBoldItalic =>
      'assets/fonts/PlayfairDisplay-BoldItalic.ttf';

  /// File path: assets/fonts/PlayfairDisplay-ExtraBold.ttf
  String get playfairDisplayExtraBold =>
      'assets/fonts/PlayfairDisplay-ExtraBold.ttf';

  /// File path: assets/fonts/PlayfairDisplay-ExtraBoldItalic.ttf
  String get playfairDisplayExtraBoldItalic =>
      'assets/fonts/PlayfairDisplay-ExtraBoldItalic.ttf';

  /// File path: assets/fonts/PlayfairDisplay-Italic.ttf
  String get playfairDisplayItalic => 'assets/fonts/PlayfairDisplay-Italic.ttf';

  /// File path: assets/fonts/PlayfairDisplay-Medium.ttf
  String get playfairDisplayMedium => 'assets/fonts/PlayfairDisplay-Medium.ttf';

  /// File path: assets/fonts/PlayfairDisplay-MediumItalic.ttf
  String get playfairDisplayMediumItalic =>
      'assets/fonts/PlayfairDisplay-MediumItalic.ttf';

  /// File path: assets/fonts/PlayfairDisplay-Regular.ttf
  String get playfairDisplayRegular =>
      'assets/fonts/PlayfairDisplay-Regular.ttf';

  /// File path: assets/fonts/PlayfairDisplay-SemiBold.ttf
  String get playfairDisplaySemiBold =>
      'assets/fonts/PlayfairDisplay-SemiBold.ttf';

  /// File path: assets/fonts/PlayfairDisplay-SemiBoldItalic.ttf
...
class $AssetsIconsNavigationGen {
  ...
  /// File path: assets/icons/navigation/home_icon.svg
  String get homeIcon => 'assets/icons/navigation/home_icon.svg';

  /// File path: assets/icons/navigation/search_icon.svg
  String get searchIcon => 'assets/icons/navigation/search_icon.svg';

  /// List of all assets
  List<String> get values => [homeIcon, searchIcon];
}
